...
@interface SITableViewIndex () <UIGestureRecognizerDelegate>
...
@implementation SITableViewIndex
...
- (instancetype)initWithFrame:(CGRect)frame indexTitles:(NSArray *)indexTitles {
    ...
    if (CGRectGetWidth(frame) > CGRectGetHeight(frame)) {
        _direction = SITableViewIndexDirectionHorizontal;
    } else {
        _direction = SITableViewIndexDirectionVertical;
    }
...
- (void)setupWithIndexTitles:(NSArray *)indexTitles {
    ...
    _font = [SIFont systemFontOfSize:12];
...
- (void)layoutSubviews {
    ...
    switch (_direction) {
        case SITableViewIndexDirectionHorizontal:
            ...
            break;
        case SITableViewIndexDirectionVertical:
