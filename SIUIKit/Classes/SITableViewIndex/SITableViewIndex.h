...
@protocol SITableViewIndexDelegate;

/**
 The direction in which the control is oriented. Assists in determining layout values.
 */
typedef NS_ENUM(NSInteger, SITableViewIndexDirection) {
    SITableViewIndexDirectionVertical = 0,
    SITableViewIndexDirectionHorizontal
};
 ...
 */
@interface SITableViewIndex : UIControl

@property (weak, nonatomic) id<SITableViewIndexDelegate> delegate;
 ...
 */
@property (readonly) SITableViewIndexDirection direction;
...
@property (nonatomic) CGSize selectedIndexSize;
...
@protocol SITableViewIndexDelegate <NSObject>

@optional

- (void)collectionIndexView:(SITableViewIndex *)collectionIndexView isPressedOnIndex:(NSUInteger)pressedIndex indexTitle:(NSString *)indexTitle;

- (void)collectionIndexView:(SITableViewIndex *)collectionIndexView liftedFingerFromIndex:(NSUInteger)pressedIndex;
